 ...
 * @method static void share(string|array|\Zen\Contracts\Support\Arrayable $key, mixed $value = null)
 ...
 * @method static \Inertia\Response render(string $component, array|\Zen\Contracts\Support\Arrayable $props = [])
