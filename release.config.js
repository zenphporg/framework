...
export default {
  ...
  repositoryUrl: 'https://github.com/zenphporg/framework',
  ...
  plugins: [
    ...
    [
      'semantic-release-replace-plugin',
      {
        replacements: [
          {
            files: ['src/Foundation/Application.php'],
            from: "const string VERSION = '.*';",
            to: "const string VERSION = '${nextRelease.version}';",
            results: [
              {
    ...
    [
      ...
      {
        assets: ['CHANGELOG.md', 'src/Foundation/Application.php'],
