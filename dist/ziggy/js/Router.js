...
/**
 * A collection of Zen routes. This class constitutes Ziggy's main API.
 */
export default class Router extends String {
  ...
  /**
   * Parse Zen-style route parameters of any type into a normalized object.
   *
   * @example
  ...
  /**
   * Substitute Zen route model bindings in the given parameters.
   *
   * @example
