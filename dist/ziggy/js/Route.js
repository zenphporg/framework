...
/**
 * A Zen route. This class represents one route and its configuration and metadata.
 */
export default class Route {
  ...
  compile(params) {
    ...
    // because that's how Zen does it internally and it's more precise and less error-prone
